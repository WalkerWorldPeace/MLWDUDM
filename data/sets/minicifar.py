...
class minicifar(object):
    """
    Dataset statistics:
    # 64 * 600 (train) + 16 * 600 (val) + 20 * 600 (test)
    """

    def __init__(self, dataset, dataset_dir, epoch, **kwargs):
        super(minicifar, self).__init__()
        self.dataset_dir = dataset_dir
        self.train_dir = os.path.join(os.getcwd(),f'sync_image/{dataset}/{epoch}')
        self.val_dir = self.dataset_dir
        ...
        print("=> MiniImageNetCifarfs loaded")
